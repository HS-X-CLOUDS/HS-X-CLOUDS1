...
def bot_sys_stats():
    ...
    stats = f"""
ᴄᴘᴜ : {cpu}% | ʀᴀᴍ : {mem}%
ᴅʟ : {num_active} | ᴜᴘ : {num_upload} | sᴘʟɪᴛ : {num_split}
ᴢɪᴘ : {num_archi} | ᴜɴᴢɪᴘ : {num_extract} | ᴛᴏᴛᴀʟ : {tasks}
ʟɪᴍɪᴛs : ᴛ/ᴅ : {TORRENT_DIRECT_LIMIT}ɢʙ | ᴢ/ᴜ : {ZIP_UNZIP_LIMIT}ɢʙ
                    L : {LEECH_LIMIT}ɢʙ | ᴍ : {MEGA_LIMIT}ɢʙ
ᴍᴀᴅᴇ ᴡɪᴛʜ ʙʏ {CREDIT_NAME}
"""
    return stats
